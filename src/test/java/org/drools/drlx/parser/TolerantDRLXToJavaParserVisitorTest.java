...
class TolerantDRLXToJavaParserVisitorTest {
    ...
    void incompleteRule_SystemOut() {
        ...
        FieldAccessExpr scopeFieldAccessExpr = (FieldAccessExpr) fieldAccess.getScope();
        ...
        // Test type resolution of System
        FieldAccessExpr systemOutExpr = (FieldAccessExpr) fieldAccess.getScope();
         ResolvedType outType = systemOutExpr.calculateResolvedType();
